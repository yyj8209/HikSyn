...
//     _CrtSetBreakAlloc(21094);
    ...
    //设置openssl路径
    //if (!NET_DVR_SetSDKInitCfg(NET_SDK_INIT_CFG_LIBEAY_PATH, "D:\\HCNetSDKT\\openssl-1.1.1dwin64\\out64dll\\libcrypto-1_1-x64.dll"))
    //{
    //    DWORD dwErrCode = NET_DVR_GetLastError();
    //    char szErrLan[128] = { 0 };
    //    sprintf_s(szErrLan, "ErrCode:%d", dwErrCode);
    ...
    //if (!NET_DVR_SetSDKInitCfg(NET_SDK_INIT_CFG_SSLEAY_PATH, "D:\\HCNetSDKT\\openssl-1.1.1dwin64\\out64dll\\libssl-1_1-x64.dll"))
    //{
    //    DWORD dwErrCode = NET_DVR_GetLastError();
    //    char szErrLan[128] = { 0 };
    //    sprintf_s(szErrLan, "ErrCode:%d", dwErrCode);
