...
public:
    ...
    CComboBox m_comboMixMode;
    CComboBox m_SupLightMode;
    BYTE m_byHighIrLightBrightness;
    BYTE m_byHighWhiteLightBrightness;
    BYTE m_byIrLightBrightness;
    BYTE m_byLowIrLightBrightness;
    BYTE m_byLowWhiteLightBrightness;
    BYTE m_byWhiteLightBrightness;
};
