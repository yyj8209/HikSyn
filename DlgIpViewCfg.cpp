...
void CDlgIpViewCfg::DoDataExchange(CDataExchange* pDX)
{
    ...
    //}}AFX_DATA_MAP
    DDX_Control(pDX, IDC_COMBO_NETWORK_TYPE, m_comboNetworkType);
}
...
void CDlgIpViewCfg::OnBtnGetSipCfg()
{
    ...
    m_comboNetworkType.SetCurSel(m_struSipCfg.byNetWork);
...
void CDlgIpViewCfg::OnBtnSetSipCfg()
{
    ...
    m_struSipCfg.byNetWork = m_comboNetworkType.GetCurSel();
...
BOOL CDlgIpViewCfg::OnInitDialog()
{
    ...
    int index = 0;
    char szLan[128] = { 0 };
    m_comboNetworkType.ResetContent();
    g_StringLanType(szLan, "无效", "invalid");
    m_comboNetworkType.InsertString(index, szLan);
    m_comboNetworkType.SetItemData(index, 1);

    ++index;
    g_StringLanType(szLan, "有线网络1", "WiredNetwork1");
    m_comboNetworkType.InsertString(index, szLan);
    m_comboNetworkType.SetItemData(index, 2);

    ++index;
    g_StringLanType(szLan, "有线网络2", "WiredNetwork2");
    m_comboNetworkType.InsertString(index, szLan);
    m_comboNetworkType.SetItemData(index, 3);

    ++index;
    g_StringLanType(szLan, "无线网络", "WirelessNetwork");
    m_comboNetworkType.InsertString(index, szLan);
    m_comboNetworkType.SetItemData(index, 4);
