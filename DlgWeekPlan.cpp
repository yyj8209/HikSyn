...
void CDlgWeekPlan::OnButAchgGet() 
{
    ...
    BYTE byGroupName[HOLIDAY_GROUP_NAME_LEN + 1] = { 0 };
    ...
    case 0:
        ...
        memset(byGroupName, 0, HOLIDAY_GROUP_NAME_LEN + 1);
        memcpy(byGroupName, m_struGroupCfg.byGroupName, HOLIDAY_GROUP_NAME_LEN);
        m_csGroupName.Format("%s", (char *)byGroupName);
...
void CDlgWeekPlan::OnButAcptSet()
{
    ...
    case 0:
        ...
        strncpy((char *)m_struTemplateCfg.byTemplateName, (LPCTSTR)m_csTemplateName, sizeof(m_struTemplateCfg.byTemplateName));
