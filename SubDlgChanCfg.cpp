...
// 			m_comboResolution.GetCurSel(), TRUE);
        if (m_comboResolution.GetItemData(m_comboResolution.GetCurSel()) < 255)
        {
...
void CSubDlgChanCfg::AddResolution()
{
    ...
    m_comboResolution.InsertString(index, "7680*4320");
    m_comboResolution.SetItemData(index, 211);
    index++;

    m_comboResolution.InsertString(index, "5760*3240");
    m_comboResolution.SetItemData(index, 212);
    index++;

    m_comboResolution.InsertString(index, "3264*1836");
    m_comboResolution.SetItemData(index, 213);
    index++;

    m_comboResolution.InsertString(index, "2712*1536");
    m_comboResolution.SetItemData(index, 214);
    index++;

    m_comboResolution.InsertString(index, "1080*720");
    m_comboResolution.SetItemData(index, 215);
    index++;

    m_comboResolution.InsertString(index, "360x640");
    m_comboResolution.SetItemData(index, 216);
    index++;

    m_comboResolution.InsertString(index, "1440*812");
    m_comboResolution.SetItemData(index, 217);
    index++;

    m_comboResolution.InsertString(index, "8160*2416");
    m_comboResolution.SetItemData(index, 218);
    index++;

    m_comboResolution.InsertString(index, "5760*1712");
    m_comboResolution.SetItemData(index, 219);
    index++;

    m_comboResolution.InsertString(index, "4080*1200");
    m_comboResolution.SetItemData(index, 220);
    index++;

    m_comboResolution.InsertString(index, "6144*2560");
    m_comboResolution.SetItemData(index, 221);
    index++;

    m_comboResolution.InsertString(index, "1568*656");
    m_comboResolution.SetItemData(index, 222);
    index++;

    m_comboResolution.InsertString(index, "4096*1808");
    m_comboResolution.SetItemData(index, 223);
    index++;

    m_comboResolution.InsertString(index, "2720*1200");
    m_comboResolution.SetItemData(index, 224);
    index++;

    m_comboResolution.InsertString(index, "2896*848");
    m_comboResolution.SetItemData(index, 225);
    index++;

    m_comboResolution.InsertString(index, "2048*608");
    m_comboResolution.SetItemData(index, 226);
    index++;

    m_comboResolution.InsertString(index, "3840*1120");
    m_comboResolution.SetItemData(index, 227);
    index++;

    m_comboResolution.InsertString(index, "2720*784");
    m_comboResolution.SetItemData(index, 228);
    index++;

    m_comboResolution.InsertString(index, "1920*560");
    m_comboResolution.SetItemData(index, 229);
    index++;

    m_comboResolution.InsertString(index, "1360*400");
    m_comboResolution.SetItemData(index, 230);
    index++;

    m_comboResolution.InsertString(index, "704*208");
    m_comboResolution.SetItemData(index, 231);
    index++;

    m_comboResolution.InsertString(index, "496*144");
    m_comboResolution.SetItemData(index, 232);
    index++;

    m_comboResolution.InsertString(index, "352*128");
    m_comboResolution.SetItemData(index, 233);
    index++;

    m_comboResolution.InsertString(index, "512*240");
    m_comboResolution.SetItemData(index, 234);
    index++;

    m_comboResolution.InsertString(index, "512*160");
    m_comboResolution.SetItemData(index, 235);
    index++;

    m_comboResolution.InsertString(index, "368*128");
    m_comboResolution.SetItemData(index, 236);
    index++;

    m_comboResolution.InsertString(index, "256*128");
    m_comboResolution.SetItemData(index, 237);
    index++;

    m_comboResolution.InsertString(index, "2048*592");
    m_comboResolution.SetItemData(index, 238);
    index++;

    m_comboResolution.InsertString(index, "1456*416");
    m_comboResolution.SetItemData(index, 239);
    index++;

    m_comboResolution.InsertString(index, "1024*304");
    m_comboResolution.SetItemData(index, 240);
    index++;

    m_comboResolution.InsertString(index, "1280*368");
    m_comboResolution.SetItemData(index, 241);
    index++;

    m_comboResolution.InsertString(index, "912*256");
    m_comboResolution.SetItemData(index, 242);
    index++;

    m_comboResolution.InsertString(index, "640*192");
    m_comboResolution.SetItemData(index, 243);
    index++;

    m_comboResolution.InsertString(index, "252*112");
    m_comboResolution.SetItemData(index, 244);
    index++;

    m_comboResolution.InsertString(index, "(576*704[P]/480*704[N])");
    ...
    m_comboResolution.InsertString(index, "3888*1696");
    ...
    m_comboResolution.InsertString(index, "496*224");
    m_comboResolution.SetItemData(index, 258);
    index++;

    m_comboResolution.InsertString(index, "352*160");
    m_comboResolution.SetItemData(index, 259);
    index++;

    m_comboResolution.InsertString(index, "912*400");
    m_comboResolution.SetItemData(index, 260);
    index++;

    m_comboResolution.InsertString(index, "640*288");
    m_comboResolution.SetItemData(index, 261);
    index++;

    m_comboResolution.InsertString(index, "1456*640");
    m_comboResolution.SetItemData(index, 262);
    index++;

    m_comboResolution.InsertString(index, "263-1024*448");
    m_comboResolution.SetItemData(index, 263);
    index++;

    m_comboResolution.InsertString(index, "2896*1280");
    m_comboResolution.SetItemData(index, 264);
    index++;

    m_comboResolution.InsertString(index, "2544*1080");
    m_comboResolution.SetItemData(index, 265);
    index++;

    m_comboResolution.InsertString(index, "2736*768");
    m_comboResolution.SetItemData(index, 266);
    index++;

    m_comboResolution.InsertString(index, "1920*544");
    m_comboResolution.SetItemData(index, 267);
    index++;

    m_comboResolution.InsertString(index, "3840*1696");
    m_comboResolution.SetItemData(index, 268);
    index++;

    m_comboResolution.InsertString(index, "2880*848");
    m_comboResolution.SetItemData(index, 269);
    index++;

    m_comboResolution.InsertString(index, "5424*2400");
    m_comboResolution.SetItemData(index, 270);
    index++;

    m_comboResolution.InsertString(index, "5520*1600");
    m_comboResolution.SetItemData(index, 271);
    index++;

    m_comboResolution.InsertString(index, "848*376");
    m_comboResolution.SetItemData(index, 272);
    index++;

    m_comboResolution.InsertString(index, "912*272");
    m_comboResolution.SetItemData(index, 273);
    index++;

    m_comboResolution.InsertString(index, "1360*600");
    m_comboResolution.SetItemData(index, 274);
    index++;

    m_comboResolution.InsertString(index, "1456*432 ");
    m_comboResolution.SetItemData(index, 275);
    index++;

    m_comboResolution.InsertString(index, "2736*1200");
    ...
    m_comboResolution.InsertString(index, "8160*2400");
    m_comboResolution.SetItemData(index, 278);
    index++;

    m_comboResolution.InsertString(index, "5520*2400");
    m_comboResolution.SetItemData(index, 279);
    index++;

    m_comboResolution.InsertString(index, "4608*2592");
    m_comboResolution.SetItemData(index, 280);
    index++;

    m_comboResolution.InsertString(index, "4944*3280");
    m_comboResolution.SetItemData(index, 281);
    index++;

    m_comboResolution.InsertString(index, "6016*4008");
    m_comboResolution.SetItemData(index, 282);
    index++;

    m_comboResolution.InsertString(index, "720*480");
    m_comboResolution.SetItemData(index, 283);
    index++;

    m_comboResolution.InsertString(index, "3200*2400");
    m_comboResolution.SetItemData(index, 284);
    index++;

    m_comboResolution.InsertString(index, "2784*800");
    m_comboResolution.SetItemData(index, 285);
    index++;

    m_comboResolution.InsertString(index, "1968*848");
    m_comboResolution.SetItemData(index, 286);
    index++;

    m_comboResolution.InsertString(index, "1392*608");
    m_comboResolution.SetItemData(index, 287);
    index++;

    m_comboResolution.InsertString(index, "2736*1184");
    m_comboResolution.SetItemData(index, 288);
    index++;

    m_comboResolution.InsertString(index, "1920*848");
    m_comboResolution.SetItemData(index, 289);
    index++;

    m_comboResolution.InsertString(index, "2560*2880");
    m_comboResolution.SetItemData(index, 290);
    index++;

    m_comboResolution.InsertString(index, "1944*1212");
    m_comboResolution.SetItemData(index, 291);
    index++;

    m_comboResolution.InsertString(index, "1920*2400");
    m_comboResolution.SetItemData(index, 292);
    index++;

    m_comboResolution.InsertString(index, "384*384");
    m_comboResolution.SetItemData(index, 293);
    index++;

    m_comboResolution.InsertString(index, "768*768");
    m_comboResolution.SetItemData(index, 294);
    index++;

    m_comboResolution.InsertString(index, "4800*2688");
    m_comboResolution.SetItemData(index, 295);
    index++;

    m_comboResolution.InsertString(index, "6480*1080");
    m_comboResolution.SetItemData(index, 296);
    index++;

    m_comboResolution.InsertString(index, "8640*1440");
    m_comboResolution.SetItemData(index, 297);
    index++;

    m_comboResolution.InsertString(index, "4800*800");
    m_comboResolution.SetItemData(index, 298);
    index++;

    m_comboResolution.InsertString(index, "6720*1200");
    m_comboResolution.SetItemData(index, 299);
    index++;

    m_comboResolution.InsertString(index, "3600*600");
    m_comboResolution.SetItemData(index, 300);
    index++;

    m_comboResolution.InsertString(index, "4800*840");
    m_comboResolution.SetItemData(index, 301);
    index++;

    m_comboResolution.InsertString(index, "2400*400");
    m_comboResolution.SetItemData(index, 302);
    index++;

    m_comboResolution.InsertString(index, "3072*540");
    m_comboResolution.SetItemData(index, 303);
    index++;

    m_comboResolution.InsertString(index, "1440*810");
    m_comboResolution.SetItemData(index, 304);
    index++;

    m_comboResolution.InsertString(index, "1920*320");
    m_comboResolution.SetItemData(index, 305);
    index++;

    m_comboResolution.InsertString(index, "2688*480");
    m_comboResolution.SetItemData(index, 306);
    index++;

    m_comboResolution.InsertString(index, "1440*240");
    m_comboResolution.SetItemData(index, 307);
    index++;

    m_comboResolution.InsertString(index, "4800*1792");
    m_comboResolution.SetItemData(index, 308);
    index++;

    m_comboResolution.InsertString(index, "3360*1264");
    m_comboResolution.SetItemData(index, 309);
    index++;

    m_comboResolution.InsertString(index, "2304*880");
    m_comboResolution.SetItemData(index, 310);
    index++;

    m_comboResolution.InsertString(index, "3840*1440");
    m_comboResolution.SetItemData(index, 311);
    index++;

    m_comboResolution.InsertString(index, "2688*1008");
    ...
    m_comboResolution.InsertString(index, "1248*496");
    m_comboResolution.SetItemData(index, 314);
    index++;

    m_comboResolution.InsertString(index, "1920*720");
    m_comboResolution.SetItemData(index, 315);
    index++;

    m_comboResolution.InsertString(index, "1344*496");
    m_comboResolution.SetItemData(index, 316);
    index++;

    m_comboResolution.InsertString(index, "912*336");
    m_comboResolution.SetItemData(index, 317);
    index++;

    m_comboResolution.InsertString(index, "1280*480");
    m_comboResolution.SetItemData(index, 318);
    index++;

    m_comboResolution.InsertString(index, "864*336");
    m_comboResolution.SetItemData(index, 319);
    index++;

    m_comboResolution.InsertString(index, "576*224");
    m_comboResolution.SetItemData(index, 320);
    index++;

    m_comboResolution.InsertString(index, "2704*1008");
    m_comboResolution.SetItemData(index, 321);
    index++;

    m_comboResolution.InsertString(index, "1904*704");
    m_comboResolution.SetItemData(index, 322);
    index++;

    m_comboResolution.InsertString(index, "1808*672");
    m_comboResolution.SetItemData(index, 323);
    index++;

    m_comboResolution.InsertString(index, "1264*464");
    m_comboResolution.SetItemData(index, 324);
    index++;

    m_comboResolution.InsertString(index, "944*336");
    m_comboResolution.SetItemData(index, 325);
    index++;

    m_comboResolution.InsertString(index, "2400*1344");
    ...
    m_comboResolution.InsertString(index, "4064*1792");
    m_comboResolution.SetItemData(index, 328);
    index++;

    m_comboResolution.InsertString(index, "304*112");
    m_comboResolution.SetItemData(index, 329);
    index++;

    m_comboResolution.InsertString(index, "960*360");
    m_comboResolution.SetItemData(index, 330);
    index++;

    m_comboResolution.InsertString(index, "672*240");
    m_comboResolution.SetItemData(index, 331);
    index++;

    m_comboResolution.InsertString(index, "464*160");
    m_comboResolution.SetItemData(index, 332);
    index++;

    m_comboResolution.InsertString(index, "896*336");
    m_comboResolution.SetItemData(index, 333);
    index++;

    m_comboResolution.InsertString(index, "624*224");
    m_comboResolution.SetItemData(index, 334);
    index++;

    m_comboResolution.InsertString(index, "640*240");
    m_comboResolution.SetItemData(index, 335);
    index++;

    m_comboResolution.InsertString(index, "448*160");
