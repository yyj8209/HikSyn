...
void CDlgVcaRuleCfgEx::DoDataExchange(CDataExchange* pDX)
{
    ...
    DDX_CBIndex(pDX, IDC_COMBO_CHANNEL_LIST, m_iVCAChannelID);
    ...
    DDX_Control(pDX, IDC_CHK_SCENE_ENABLE, m_checkSceneEnable);
}
...
//     }NET_VCA_OVER_TIME, *LPNET_VCA_OVER_TIME;
    ...
    case ENUM_VCA_EVENT_AUDIO_ABNORMAL:
        ...
        m_iRuleParam5 = uEventParam.struAudioAbnormal.bySensitivity;
        m_iRuleParam3 = uEventParam.struAudioAbnormal.wDecibel;
        m_iRuleParam4 = uEventParam.struAudioAbnormal.byThreshold;
...
void CDlgVcaRuleCfgEx::GetEventUnionFromWnd(NET_VCA_EVENT_UNION &uEventParam, DWORD dwEventType)
{
    ...
    case ENUM_VCA_EVENT_AUDIO_ABNORMAL:
        ...
        uEventParam.struAudioAbnormal.bySensitivity = (BYTE)m_iRuleParam5;
        uEventParam.struAudioAbnormal.wDecibel = m_iRuleParam3;
        uEventParam.struAudioAbnormal.byThreshold = m_iRuleParam4;
        break;
    case ENUM_VCA_EVENT_ADV_REACH_HEIGHT:
    ...
    case ENUM_VCA_EVENT_TOILET_TARRY:
        ...
        uEventParam.struToiletTarry.wDelay = m_iRuleParam3;
        break;
    case ENUM_VCA_EVENT_YARD_TARRY:
...
void CDlgVcaRuleCfgEx::SetHandleExceptionToWnd(NET_DVR_HANDLEEXCEPTION_V40 const &struHandleException)
{
    ...
    for (nIndex = 0; nIndex < struHandleException.dwMaxRelAlarmOutChanNum; nIndex++)
    {
        ...
        m_listAlarmOut.SetItemData(nIndex, nIndex);
    }
...
void CDlgVcaRuleCfgEx::GetHandleExceptionFromWnd(NET_DVR_HANDLEEXCEPTION_V40 &struHandleException)
{
    ...
    memset(&struHandleException.dwRelAlarmOut, 0xfffffffff, sizeof(struHandleException.dwRelAlarmOut));
    if (m_bHandleType4)
    {
        int iChannelIndex = 0;
...
void    CDlgVcaRuleCfgEx::GetUploadCfgFromWnd()
{
    ...
    m_struVcaRule.m_struRuleCfg.struPicParam.wPicSize = (unsigned short)m_comboResolution.GetCurSel();
...
void    CDlgVcaRuleCfgEx::SetUploadCfgToWnd(NET_VCA_RULECFG_V42 const &struVcaRuleCfg)
{
    ...
    m_comboResolution.SetCurSel(struVcaRuleCfg.struPicParam.wPicSize);
...
{
    UpdateData(TRUE);
    m_struVcaRule.m_struRuleCfg.struPTZPosition.byEnable = m_checkSceneEnable.GetCheck();
}
//将场景位置信息显示到界面
void  CDlgVcaRuleCfgEx::SetPtzPositionToWnd(NET_DVR_PTZ_POSITION const &struPTZPosition)
{
    m_checkSceneEnable.SetCheck(struPTZPosition.byEnable); 
    UpdateData(FALSE);
}
