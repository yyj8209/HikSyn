...
BOOL CDlgTalkMREx::SendDataToDVR(char *buf, DWORD dwSize)
{
    ...
    //struEncProcParam.in_buf = (BYTE*)wVoiceBuf1;
    //struEncProcParam.out_buf = G711EncBuf;
    //NET_DVR_EncodeG711Frame(m_pG711Enc, &struEncProcParam);
    //struEncProcParam.g711_type = 0;
    //struEncProcParam.in_buf = (BYTE*)wVoiceBuf2;
    //struEncProcParam.out_buf = G711EncBuf + G711_AUDDECSIZE;
    //NET_DVR_EncodeG711Frame(m_pG711Enc, &struEncProcParam);

    //AUDIOTALKTYPE_G711_MU与AUDIOTALKTYPE_G711_A使用同一个库编码，参数不一样，不能同时编码，否则相互有影响
    ...
    struEncProcParam.g711_type = 1;
    struEncProcParam.in_buf = (BYTE*)wVoiceBuf2;
    struEncProcParam.out_buf = G711EncBufA + G711_AUDDECSIZE;
    NET_DVR_EncodeG711Frame(m_pG711Enc, &struEncProcParam);
#endif
